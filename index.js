...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] RIKKA~CHAN BOT Ready scan now!`);
});
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6289504242949* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah YareYareBot
